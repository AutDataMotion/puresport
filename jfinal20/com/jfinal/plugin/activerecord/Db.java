...
public class Db {
	 ...
	 * @throws SQLException
	 */
	static Page<Record> paginateDistinct(Config config, Connection conn, int pageNumber, int pageSize,
			String selectColumn, String selectCount, String sqlExceptSelect, Object... paras) throws SQLException {
		return dbPro.paginateDistinct(config, conn, pageNumber, pageSize, selectColumn, selectCount, sqlExceptSelect,
				paras);
	}
	 ...
	 * @return
	 */
	public static Page<Record> paginateDistinct(int pageNumber, int pageSize, String selectColumn, String selectCount,
	 ...
	 * @return
	 */
	public static boolean saveOtherwiseUpdate(String tableName, String primaryKey, Record record) {
		// 是否存在
		Record existRecord = findById(tableName, primaryKey, record);
		if (null == existRecord) {
			// 插入
			return save(tableName, primaryKey, record);
		} else {
			// 更新
			return update(tableName, primaryKey, existRecord);
		}
	}
