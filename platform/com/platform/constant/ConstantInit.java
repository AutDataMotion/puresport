...
public interface ConstantInit {
	...
	//ftp配置
	public static final String ftp_ip = "config.ftp.ip";
	
	public static final String ftp_port = "config.ftp.port";
	
	public static final String ftp_username = "config.ftp.username";

	public static final String ftp_pwd = "config.ftp.pwd";
