...
-- Records of t7_crcl
-- ----------------------------
INSERT INTO `t7_crcl` VALUES ('1', '2015年7月至2016年4月，河南省女子田径运动员刘某某，接受生物护照检查，多项血液样本检测数据异常。经生物护照评估委员会审查，判定为生物护照阳性结果。\r\n          生物护照评估委员会审核了运动员提交的血液样本解释材料，一致认为该检测数据异常不是由生理或病理原因造成，因此判定该运动员兴奋剂违规。之后，运动员方又申请召开听证会，听证委员会一致认为对运动员刘某某检查检测的判定符合相关国际标准和指南，且运动员方未能对其兴奋剂违规提供合理解释。\r\n', '1', '反兴奋剂准入系统操作流程.', '/materials/video/反兴奋剂准入系统操作流程..mp4', '1', '1', '1', '2018-05-19 23:54:17', 'fyh.jpg');
